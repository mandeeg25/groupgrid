...
function GroupGrid({ user, onLogin, onLogout }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#F0F2F7", fontFamily:font, fontSize:"15px", WebkitFontSmoothing:"antialiased" }}>
      ...
      {/* Header */}
      <div style={{ background:P.navy, padding:"0 32px", display:"flex", alignItems:"center", justifyContent:"space-between", height:"52px", boxShadow:"0 1px 0 rgba(255,255,255,0.06)" }}>
        <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 52" width="185" height="46" style={{display:"block"}}>
              <defs>
      ...
      <div style={{ display:"flex", flex:1, maxWidth:"1400px", margin:"0 auto", width:"100%", minHeight:"calc(100vh - 52px)", alignItems:"flex-start" }}>
        ...
        {/* ── Left Sidebar ── */}
        <div style={{ width:224, flexShrink:0, background:P.navy, borderRight:`1px solid rgba(255,255,255,0.07)`, display:"flex", flexDirection:"column", padding:"20px 14px", overflowY:"auto", position:"sticky", top:0, height:"calc(100vh - 52px)", alignSelf:"flex-start" }}>
