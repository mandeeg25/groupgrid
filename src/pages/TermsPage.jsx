  ...
  return (
    <PageShell title="Terms of Service" onBack={onBack} nav={nav}>
      ...
      <Section title="3. Acceptable Use">
        You may use GroupGrid only for lawful purposes and in accordance with these Terms. You agree not to: (a) use the Service to process data you do not have authorization to access; (b) attempt to reverse-engineer, decompile, or compromise the Service; (c) use the Service in any manner that violates applicable laws or regulations, including data protection laws; (d) scrape, crawl, harvest, or use any automated means or artificial intelligence system to copy, index, or reproduce the Service, its content, its user interface, or its underlying logic; or (e) use the Service, its content, or its design to build, train, or develop a competing or substantially similar product or service.
      </Section>
      ...
      <Section title="5. Intellectual Property">
        GroupGrid and its original content, features, functionality, design, and branding (including the GroupGrid name and logo) are owned by GroupGrid and are protected by international copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, reproduce, republish, or create derivative works of the Service, its interface, or its content without our prior written consent. This includes cloning or closely imitating the Service's look, feel, or functionality, and using automated or AI tools to do so. The Service and its underlying methods are the subject of one or more pending patent applications.
      </Section>
