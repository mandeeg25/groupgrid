  ...
  return (
    <PageShell title="Privacy Policy" onBack={onBack} nav={nav}>
      ...
      <Section title="Cookies">
        GroupGrid's core app does not rely on tracking cookies to function. Our marketing site uses analytics and marketing tools that set cookies only if you accept them through our consent banner; if you decline, none of them load. Vercel Web Analytics, which is cookieless, runs regardless.
      </Section>
      ...
      <Section title="GDPR & CCPA">
        The personal data we hold is limited to your account email and, if you submitted our signup form, the details you provided. If you accept analytics, usage data is also processed. Your saved projects are stored locally on your own device, not on our servers. You have the right to access, export, and permanently delete your account-associated data upon request.
      </Section>
      <Section title="Third-party services">
        GroupGrid relies on a small number of trusted providers for authentication, payments, analytics, and CRM/outreach, and can share our current list on request. With your consent, our marketing site also uses analytics and marketing tools. Your guest spreadsheet files are never sent to any of these services — they are processed only in your browser. Fonts load from Google Fonts.
      </Section>
